...
class ProductConsumeLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_consume_log" do
    assert_difference("ProductConsumeLog.count") do
      post product_consume_logs_url, params: { product_consume_log: { product_id: @product_consume_log.product_id, use_ended_at: @product_consume_log.use_ended_at, use_started_at: @product_consume_log.use_started_at } }
    end
  ...
  test "should update product_consume_log" do
    patch product_consume_log_url(@product_consume_log), params: { product_consume_log: { product_id: @product_consume_log.product_id, use_ended_at: @product_consume_log.use_ended_at, use_started_at: @product_consume_log.use_started_at } }
